...
object PrayerCalculator {
    ...
    // ط­ط³ط§ط¨ ظ…ظˆط§ظ‚ظٹطھ ط§ظ„طµظ„ط§ط© ط¨ط¯ظˆظ† ط¥ظ†طھط±ظ†طھ
    ...
    fun getPrayerList(times: PrayerTimes): List<PrayerTime> = listOf(
        PrayerTime("Fajr", "ط§ظ„ظپط¬ط±", times.fajr, 0),
        PrayerTime("Dhuhr", "ط§ظ„ط¸ظ‡ط±", times.dhuhr, 1),
        PrayerTime("Asr", "ط§ظ„ط¹طµط±", times.asr, 2),
        PrayerTime("Maghrib", "ط§ظ„ظ…ط؛ط±ط¨", times.maghrib, 3),
        PrayerTime("Isha", "ط§ظ„ط¹ط´ط§ط،", times.isha, 4)
    )
